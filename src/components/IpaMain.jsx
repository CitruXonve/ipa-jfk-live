...
import { Container, AppBar, Card, CardContent, CardHeader, CssBaseline, Link, Toolbar, Typography, Grid, Box } from '@material-ui/core';
...
class IpaMain extends React.Component {
  constructor(props) {
    super(props);
  }
...
export default withStyles(useStyles)(IpaMain);
